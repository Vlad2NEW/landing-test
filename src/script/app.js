const productInfo = [
  { id: 1, category: 'Vegetable', imgSrc: './assets/images/product-photo-1.png', title: 'Calabrese Broccoli', price: '$20.00', discountPrice: '$13.00', rating: 4.7 },
  { id: 2, category: 'Fresh', imgSrc: './assets/images/product-photo-2.png', title: 'Fresh Banana Fruits', price: '$20.00', discountPrice: '$14.00', rating: 5 },
  { id: 3, category: 'Millets', imgSrc: './assets/images/product-photo-3.png', title: 'White Nuts', price: '$20.00', discountPrice: '$15.00', rating: 4.5 },
  { id: 4, category: 'Vegetable', imgSrc: './assets/images/product-photo-4.png', title: 'Vegan Red Tomato', price: '$20.00', discountPrice: '$17.00', rating: 4 },
  { id: 5, category: 'Health', imgSrc: './assets/images/product-photo-5.png', title: 'Mung Bean', price: '$20.00', discountPrice: '$11.00', rating: 3.3 },
  { id: 6, category: 'Nuts', imgSrc: './assets/images/product-photo-6.png', title: 'Brown Hazelnut', price: '$20.00', discountPrice: '$12.00', rating: 4.6 },
  { id: 7, category: 'Fresh', imgSrc: './assets/images/product-photo-7.png', title: 'Eggs', price: '$20.00', discountPrice: '$17.00', rating: 4.3 },
  { id: 8, category: 'Fresh', imgSrc: './assets/images/product-photo-8.png', title: 'Zelco Suji Elaichi Rusk', price: '$20.00', discountPrice: '$15.00', rating: 4.7 },
  { id: 9, category: 'Fruit', imgSrc: './assets/images/product-photo-9.png', title: 'Organic Apples', price: '$25.00', discountPrice: '$20.00', rating: 4.9 },
  { id: 10, category: 'Dairy', imgSrc: './assets/images/product-photo-10.png', title: 'Greek Yogurt', price: '$15.00', discountPrice: '$10.00', rating: 4.8 },
  { id: 11, category: 'Vegetable', imgSrc: './assets/images/product-photo-11.png', title: 'Fresh Spinach', price: '$18.00', discountPrice: '$12.00', rating: 4.6 },
  { id: 12, category: 'Grains', imgSrc: './assets/images/product-photo-12.png', title: 'Brown Rice', price: '$22.00', discountPrice: '$16.00', rating: 4.4 },
  { id: 13, category: 'Herbs', imgSrc: './assets/images/product-photo-13.png', title: 'Fresh Basil', price: '$10.00', discountPrice: '$8.00', rating: 4.7 },
  { id: 14, category: 'Snack', imgSrc: './assets/images/product-photo-14.png', title: 'Trail Mix', price: '$18.00', discountPrice: '$14.00', rating: 4.5 },
  { id: 15, category: 'Beverage', imgSrc: './assets/images/product-photo-15.png', title: 'Green Tea', price: '$12.00', discountPrice: '$9.00', rating: 4.8 },
  { id: 16, category: 'Frozen', imgSrc: './assets/images/product-photo-16.png', title: 'Frozen Berries', price: '$15.00', discountPrice: '$11.00', rating: 4.6 }
];
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  new Glide('.sec5-cards', { type: 'carousel', startAt: 0, perView: 1 }).mount();
  ...
  btnIdsToOpenModal.forEach((btnId) => {
    ...
    btnEl.addEventListener('click', function () {
      ...
      if (modalId === 'cart-modal') displaySelectedProducts();
    });
  });
  ...
  function showCards() {
    ...
    if (activeVisibleCards >= productInfo.length) loadMoreProductCards.querySelector('span').textContent = 'Load Less';
  }
  ...
  loadMoreProductCards.addEventListener('click', function () {
    if (activeVisibleCards < productInfo.length) showCards();
    else hideCards();
  });
  ...
  (function () { emailjs.init({ publicKey: "nJqjKYE3F_7GJUDJ3" }); })();
  ...
  formBtn.addEventListener('click', function (event) {
    ...
    if (isCurrentEmailValid) {
      emailjs.send("service_te4dxie", "template_kdz8ey9", { user_email: currentEmail })
        .then(() => {
          notifier.success('Your email has been sent successfully!');
          emailField.value = '';
        })
        .catch(() => {
          notifier.alert('Failed to send email. Please try again.');
        });
    } else {
  ...
  function handleBuyButtonClick(event) {
    ...
    if (this.classList.contains('active')) selectedProducts.push(productId);
    else selectedProducts = selectedProducts.filter(id => id !== productId);
  ...
  function displaySelectedProducts() {
    ...
    productList.innerHTML = selectedProducts.map(productId => {
      ...
      return `<li data-product-id="${productId}"><span>${productName}</span><i class="fa-regular fa-circle-xmark fa-lg" style="color: #274c5b;"></i></li>`;
    }).join('');
  ...
  updateCartValueIndicators();
  allBuyButtons.forEach(buyBtn => buyBtn.addEventListener('click', handleBuyButtonClick));
});
